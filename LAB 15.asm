.ORIG	x3000
	...
	;rowloop  
        ...
        BRz	STOP        ; determine whether it's end
		ADD r5, R1,#-1 ;check the first line
		BRn,#2
		...
		;charloop
			charloop LDI R3, char  ;R3 hold the ascii value of char
			LDI R3, char
			AND R6, R3, #-1;check if null
			BRz rowloop
			LEA R4, FONT_DATA
			ADD R3,R3,R3
			ADD R3,R3,R3
			...
			;columnloop
				and r5,R5,#0 ;initialize counter
